...
export default function PokeCard(props) {
   ...
   async function fetchMoveData(move, moveUrl){
    ...
    useEffect(()=>
    {
        ...
        if(selectedPokemon in cache)
            ...
            async function fetchPokemonData(){
                ...
                try{ 
                    ...
                    const suffex = 'pokemon/' + getPokedexNumber(selectedPokemon)
                    const finalUrl = baseUrl+suffex
        ...
        // If we fetch from the api, make sure to sav ethe information in the cache for next time
