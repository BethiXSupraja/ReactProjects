export default function Hero(){
    return(
        <>
         <h1>Coffes Tracking for Coffee<abbr title = "An enthusiast or devotee">Fiends</abbr>!</h1>
        <div className="benefits-list">
            <h3 className="font-boler">Try <span className="text-gradient">Caffiend</span> and start ...</h3>
