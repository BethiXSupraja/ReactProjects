...
export default function CoffeeForm(props){
    ...
    return(
       ...
       {showCoffeeTypes && (
        ...
        <h4>Add the cost ($)</h4>
        <input className="w-full" type="number" placeholder="4.50" value = {coffeeCost} onChange={(e)=>{setCoffeeCost(e.target.value)}}></input>
        <h4>Time since consumption</h4>
        <div className="time-entry"></div>
        <div>
            <h6>Hours</h6>
            <select onChange={(e)=>{setHour(e.target.value)}}id ="hours-selected">
        ...
        <div>
            <h6>Mins</h6>
            <select onChange={(e)=>{setMin(e.target.value)}} id ="mins-selected">
